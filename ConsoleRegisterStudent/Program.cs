...
namespace ConsoleRegisterStudent
{
    class Program
    {
        ...
        void run()
        {
            ...
            System.Console.WriteLine("Rideout's Copy");
        ...
        {
            if (choice < 1 || choice > 7) // Invalid input
                return -1;
            else if (choice == firstChoice || choice == secondChoice || choice == thirdChoice) // Already registered for choice
                return -2;
            else if (totalCredit >= 9) // Too many credit hours
                return -3;
            return 0; // Valid
        }
        ...
        {
            if (firstChoice == 0)
                Console.WriteLine("You are not registered for any courses.");
            else if (secondChoice == 0)
